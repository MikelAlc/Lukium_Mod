...
import pigman.mod.village.town.ManagedLocation;
...
public class WorldDataInstance
{
	 private World world;
	    ...
	    private int lastIDUsedForPigmanVillage = 0;
	    ...
	    public void readNBT(NBTTagCompound nbt) {
	        lastIDUsedForPigmanVillage = nbt.getInteger("lastIDUsedForPigmanVillage");
	    ...
	    public void writeNBT(NBTTagCompound nbt) {
	        nbt.setInteger("lastIDUsedForPigmanVillage", lastIDUsedForPigmanVillage);
	    ...
	    public int getAndIncrementPigmanIDVillage() {
	        return lastIDUsedForPigmanVillage++;
	    }
}
